<nav class="navbar navbar-expand-lg fixed-top py-3 backdrop" data-navbar-on-scroll="data-navbar-on-scroll">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="#">
            <!-- <img class="d-inline-block align-top img-fluid" src="{{asset('rhea/public/assets/img/gallery/UMBJM.png')}}" alt="" width="50" /> -->
            <span class="text-primary fs-4 ps-2">Get Tour</span>
        </a>
